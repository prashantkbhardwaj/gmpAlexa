                ...
                var refreshId = setInterval(function() {
                    ...
                    for (var i = 12; i < loop; i+=13) {
                        ...
                        if (locate[i-9]==drone) {
                            ...
                            document.getElementById("head").innerHTML = locate[i-6];
                            document.getElementById("pitch").innerHTML = locate[i-5];
                            document.getElementById("roll").innerHTML = locate[i-4];
                            document.getElementById("airspeed").innerHTML = locate[i-3];
                            document.getElementById("bank").innerHTML = locate[i-2];
